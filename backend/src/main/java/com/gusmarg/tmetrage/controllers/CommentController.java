...
public class CommentController {
    ...
    @GetMapping("/search")
    public List<CommentResponseDTO> searchComments(@RequestParam(required = false) String search,
	...
	public ResponseEntity<CommentResponseDTO> addComment(@PathVariable Long movieId,
