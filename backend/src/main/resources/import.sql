INSERT INTO tb_user (id, avatar, background_img_url, bio, email, name, password, profile_name) VALUES (1, 'uploads/avatars/77d24b20-1f55-476b-8d64-36d8a07dc064_teste2.jpg', NULL, NULL, 'gustavo.gmartx@gmail.com', 'Gustavo Martins', '$2a$10$LfpaOMt7Q5vRKeklhcN30ePcCL0vMwvgtrqFh4h7gr720S37IjoNS', '@gumartx');
INSERT INTO tb_user (id, avatar, background_img_url, bio, email, name, password, profile_name) VALUES (2, 'uploads/avatars/21f1031f-36d6-4754-ad7c-da23514ccc20_fofo.png', NULL, NULL, 'gustavo@gmail.com', 'Gustavo Martins', '$2a$10$ZtlbC/Degad/bJRvptaGE.poezutFWvoR1MYJHXBg42atp.EuvrGe', '@ane');
INSERT INTO tb_user (id, avatar, background_img_url, bio, email, name, password, profile_name) VALUES (3, NULL, NULL, NULL, 'bru@gmail.com', 'bruna', '$2a$10$8d9a/Trpz/HT0MxRA/1qr.YtHKXEVx7r1yu9BB53lp9uk5MKHeYh2', '@garotagelida');
...
INSERT INTO tb_list (created_at, id, user_id, description, name) VALUES ('2026-04-08', 1, 1, NULL, 'teste2');
INSERT INTO tb_list (created_at, id, user_id, description, name) VALUES ('2026-04-08', 2, 1, NULL, 'teste1');
