...
const RatedMovies = () => {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchQuery, platformFilter, ratingFilter, genreFilter, datePreset, dateFrom, dateTo, sortOrder]);
  ...
  useEffect(() => {
    ...
    const loadPage = async () => {
      setLoading(true);
      try {
        const params: Parameters<typeof getUserRatingsPaged>[0] = {
          page: currentPage - 1,
          size: PAGE_SIZE,
          sort: backendSort,
        };
  ...
  }, [currentPage, searchQuery, platformFilter, ratingFilter, genreFilter, datePreset, dateFrom, dateTo, backendSort]);
